# https://matplotlib.org/stable/gallery/index.html#Userdemo
...
ax = axs.flat[3]
ax.plot([x1, x2], [y1, y2], ".")
el = mpatches.Ellipse((x1, y1), 0.3, 0.4, angle=30, alpha=0.2) # 椭圆path
ax.add_artist(el) # 加入
ax.annotate("",
            xy=(x1, y1), xycoords='data', # xy 轴的坐标，箭头指向的点，data,安照坐标轴取值
            xytext=(x2, y2), textcoords='data',# 文字左下角起始坐标，data,按照坐标轴取值
