...
ax0_0 = fig.add_subplot(2,2,1,axisbg="yellowgreen",alpha=.1)
...
ax0_1 = fig.add_subplot(2,2,2,axisbg="yellowgreen",alpha=.1)
...
ax1_0 = fig.add_subplot(2,2,3,axisbg="yellowgreen",alpha=.1)
...
ax1_1 = fig.add_subplot(2,2,4,axisbg="yellowgreen",alpha=.1)
